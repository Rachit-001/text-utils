...
export default function TextForm(props) {
	...
	const handleCopyClick = () => {
		...
		// document.getSelection().removeAllRanges(); // to deselect text after it is copied
		// old-------------------------------------

		// new---------------------------------
		navigator.clipboard.writeText(text); // using navigator api so no need to select or deselct just pass the value directly
		// new---------------------------------
		...
		<>
			<div className="container my-3">
				<div className="form-group">
					<h1
						className={`text-${props.mode === "light" ? "dark" : "light"} mb-2`}
					>
						{" "}
						{props.heading}
					</h1>
				...
				{/* <button 
				disabled={text.length === 0} className="btn btn-danger mx-1 my-1" onClick={handleCapitalizeClick}>
					Capitalize Text
				</button> */}
			</div>
			<div className="container my-3">
